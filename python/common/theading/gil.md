### Содержание
+ [Потоки операционной системы, потоки Python и GIL](Потоки_операционной_системы,_потоки_Python_и_GIL)
+ [Последствия существования GIL](Последствия_существования_GIL)
+ [Эффект сопровождения](Эффект_сопровождения)
+ [Устранение последствий эффекта сопровождения](Устранение_последствий_эффекта_сопровождения)
+ [Какой должна быть глобальная блокировка интерпретатора?](Какой_должна_быть_глобальная_блокировка_интерпретатора?)
+ [Нельзя ли избавиться от GIL?](Нельзя_ли_избавиться_от_GIL?)
+ [Будущее GIL и конкурентности в Python](Будущее_GIL_и_конкурентности_в_Python)
