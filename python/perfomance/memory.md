### Содержание
+ [Введение](#введение)
+ [Диспетчер памяти: «командовать парадом буду я»](#диспетчер-памяти-командовать-парадом-буду-я)
+ [Организация доступной виртуальной памяти](#организация-доступной-виртуальной-памяти)
+ [Освобождение памяти: счетчик ссылок, сборщик мусора](#освобождение-памяти-счетчик-ссылок-сборщик-мусора)
+ [Заключение](#заключение)

*[Источник](https://proglib.io/p/pomnit-vse-kak-rabotaet-pamyat-v-python-2021-03-14)*
...
### Диспетчер памяти: «командовать парадом буду я»[^](#содержание)
...
### Освобождение памяти: счетчик ссылок, сборщик мусора[^](#содержание)
